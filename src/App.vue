  ...
  <div class="layout-transparent mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header mdl-layout__header--transparent">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title" style="cursor: pointer;" @click="$router.push({name:'home'})">
    ...
    <div class="mdl-layout__drawer">
      <span class="mdl-layout-title">
        <img width="32" height="32" src="/static/img/icons/logo.png" /> ROUTE64
      </span>
...
export default {
  ...
  mounted() {
    ...
    EventBus.$on('notification-received', function (payLoad) {
      showNotification({ message: (payLoad.data || payLoad.notification).body })
    })
  }
}
</script>
